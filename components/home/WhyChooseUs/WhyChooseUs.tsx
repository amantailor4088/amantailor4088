    ...
    return (
        <section className="py-16 bg-white dark:bg-neutral-900 transition-colors duration-300">
            <div className="max-w-5xl mx-auto px-6 text-center">
                ...
                {/* Features */}
                <div className="flex flex-wrap justify-center items-center gap-x-5 gap-y-6 max-w-3xl mx-auto">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className="flex items-center justify-center gap-3 sm:mx-0 sm:w-[45%]"
                        >
