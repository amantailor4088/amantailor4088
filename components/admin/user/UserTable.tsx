              ...
              >
                ...
                <td className="px-6 py-4">
                  {user.courses.length > 0 ? (
                    ...
                    <span className="text-gray-500 text-xs italic">No courses</span>
                  )}
                </td>
              </tr>
            ))}
      ...
      <div className="space-y-5 md:hidden">
        {users.map((user,idx) => (
          ...
          >
            ...
            <div className="mb-4 border-t border-gray-100 dark:border-neutral-700 pt-4"> {/* Subtle separator */}
              <p className="text-xs font-semibold uppercase text-gray-500 dark:text-gray-400 mb-2 tracking-wide">
                Contact Information
              </p>
              <div className="flex items-center gap-2">
                {/* Phone Icon */}
                <svg className="w-5 h-5 text-gray-600 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Courses Section */}
            <div className="border-t border-gray-100 dark:border-neutral-700 pt-4"> {/* Subtle separator */}
              <p className="text-xs font-semibold uppercase text-gray-500 dark:text-gray-400 mb-2 tracking-wide">
                Enrolled Courses
              </p>
              <div className="flex flex-wrap gap-2">
                {user.courses.length > 0 ? (
                  ...
                  <span className="text-gray-500 text-sm italic">No courses enrolled.</span>
                )}
              </div>
            </div>
          </div>
