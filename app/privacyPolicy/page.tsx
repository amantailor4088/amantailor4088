      ...
      <div className="max-w-4xl w-full bg-white shadow-lg rounded-lg p-8 md:p-12">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
            ...
            <li>
              <strong>Financial Data:</strong> Financial information, such as data related to your payment method (e.g., valid credit card number, brand, expiration date) that we may collect when you purchase, order, return, exchange, or request information about our services from the Site. We store only very limited, if any, financial information that we collect. Otherwise, all financial information is stored by our payment processor, Razorpay, and you are encouraged to review their privacy policy and contact them directly for responses to your questions.
            </li>
            <li>
        ...
        <section className="mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4">3. How We Use Your Information</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4">4. Disclosure of Your Information</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
            ...
            <li>
              <strong>Third-Party Service Providers:</strong> We may share your information with third parties that perform services for us or on our behalf, including payment processing (e.g., Razorpay), data analysis, email delivery, hosting services, customer service, and marketing assistance.
            </li>
            <li>
        ...
        <section className="mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4">5. Security of Your Information</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4">6. Policy for Children</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4">7. Changes to This Privacy Policy</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4">8. Contact Us</h2>
          <p className="text-gray-700 leading-relaxed">
            If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at:
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4 mt-4">
            <li>Email: Amandeepppp8@gmail.com</li>
            <li>Phone: +91 90416 07156</li>
            <li>Address:Parasram nagar, street 29, property uid z611616 Bathinda, Punjab – 151001</li>
          </ul>
        </section>
      </div>
    </div>
